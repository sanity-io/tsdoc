...
function _functionIsReactComponentType(node: ApiFunction) {
  ...
  const returnsReactElement =
    returnTypeCode === 'React.ReactElement' || returnTypeCode === 'ReactElement'
  const returnsReactNode = returnTypeCode === 'React.ReactNode' || returnTypeCode === 'ReactNode'
