 ...
 * @internal
 */
export function _transformClass(ctx: TransformContext, node: ApiClass): Serialized.APIClass {
  if (!ctx.export) {
...
function _transformClassMember(ctx: TransformContext, m: ApiItem): Serialized.APIClassMember {
