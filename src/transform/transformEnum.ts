...
import {APIEnumMember, Serialized} from '../types'
 ...
 * @internal
 */
export function _transformEnum(ctx: TransformContext, node: ApiEnum): Serialized.APIEnum {
  if (!ctx.export) {
...
function _transformEnumMember(_ctx: TransformContext, m: ApiItem): Sanity.ArrayItem<APIEnumMember> {
